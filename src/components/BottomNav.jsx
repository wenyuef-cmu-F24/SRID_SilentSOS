...
function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 flex justify-center bg-transparent">
      <div className="w-full max-w-md md:max-w-lg lg:max-w-xl bg-white border-t border-gray-200">
